module.exports = async(client, message) => {
    ...
    //AFK feature
    const mentionned = message.mentions.users.filter(u => client.userData.has(u.id) && client.userData.get(u.id).generalSettings.afk !== false);
    ...
    if (message.guild) {
        ...
        require("../util/helpers/expHandler.js")(client, message);
    }
    //Commands
