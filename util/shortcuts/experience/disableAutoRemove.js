module.exports = async(client, message, args) => {
    ...
    return new Promise(async(resolve, reject) => {
        try {
            ...
            if (!guildEntry.levelSystem.autoRemove) return resolve(await message.channel.createMessage(`:x: The automatic removal of roles is already disabled`));
            guildEntry.levelSystem.autoRemove = false;
