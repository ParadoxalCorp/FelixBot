class Karen {
    constructor() {
        this.help = {
            name: 'karen',
            description: 'Return a random image of Karen',
            usage: 'karen'
        };
    }
...
module.exports = new /*Peter() *cough cough**/ Karen();