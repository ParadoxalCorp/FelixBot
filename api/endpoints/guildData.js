    ...
    server.route({
        ...
        handler: async(req, reply) => {
            ...
            if (req.method === 'get') {
                ...
                else if (Array.isArray(typeof req.params.guildID)) return reply(Array.from(client.guildData.filter(g => req.params.guildID.has(g.id))));
                ...
                if (!isValidObject.valid) return reply(`Invalid object, the following errors have been found: \n${isValidObject.invalidKeys}`);
